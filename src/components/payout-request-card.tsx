  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-[rgb(var(--border))] dark:bg-[rgb(var(--surface))]">
      <header className="space-y-1">
        ...
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{tokenBalance.toLocaleString()} tokens available</h3>
        <p className="text-xs text-gray-500 dark:text-slate-300">{helpText}</p>
      </header>

      <form onSubmit={handleSubmit} className="mt-5 space-y-4">
        <div className="space-y-1">
          <label htmlFor="payout-amount" className="text-sm font-medium text-gray-700 dark:text-slate-200">
        ...
        <div className="space-y-1">
          <label htmlFor="payout-reference" className="text-sm font-medium text-gray-700 dark:text-slate-200">
