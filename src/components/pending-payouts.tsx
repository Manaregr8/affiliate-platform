    ...
    return (
      <div className="rounded-2xl border border-red-200 bg-red-50 p-6 text-sm text-red-700 shadow-sm">
        ...
        <button
          type="button"
          onClick={loadPayouts}
          className="ml-3 inline-flex items-center rounded-md border border-red-600 px-2 py-1 text-xs font-medium text-red-600 transition hover:bg-red-100"
        >
          Retry
        </button>
      </div>
      ...
      <div className="w-full overflow-x-auto">
        ...
        <tbody>
          {payouts.map((payout) => {
            ...
            return (
              <tr key={payout.id} className="odd:bg-white even:bg-gray-50">
              ...
              <td className="px-4 py-3 font-semibold text-gray-900">₹{payout.amount.toLocaleString()}</td>
              ...
              <td className="px-4 py-3">
                <button
                  ...
                  className="rounded-lg bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-70"
                >
