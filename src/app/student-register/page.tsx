...
export default function StudentRegisterPage() {
  return (
    <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-2xl flex-col justify-center px-6 py-16">
      <section className="rounded-3xl border border-dashed border-sky-200 bg-sky-50/40 p-12 text-center shadow-inner dark:border-slate-600 dark:bg-slate-900/50">
        <h1 className="text-3xl font-semibold text-gray-900 dark:text-gray-100">Student Registrations Are Referral-Only</h1>
        ...
        <p className="mt-6 text-sm text-gray-500 dark:text-slate-400">
          ...
          <a href="mailto:admissions@example.com" className="mx-1 font-medium text-sky-600 dark:text-sky-300">admissions@example.com</a>
